...
namespace PrvaASPNETAplikacija.Controllers
{
    public class UpisNaPredmetController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,DatumUpisa,StudentId,PredmetId")] UpisNaPredmet upisNaPredmet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,DatumUpisa,StudentId,PredmetId")] UpisNaPredmet upisNaPredmet)
        {
